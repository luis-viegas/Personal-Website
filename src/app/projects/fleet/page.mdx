...
import fleet1 from './fleet1.jpeg'
import fleet2 from './fleet2.jpeg'

export const article = {
  author: 'Luís Viegas',
  date: '2023-06-02',
  title: 'Fleet: Bringing Live Athletics Results to Mobile',
  description:
    'How I built a real-time athletics results app from scratch.',
}
...
<Image className="max-h-[500px] object-contain" src={fleet1}  />
...
<Image className="max-h-[500px] object-contain" src={fleet2}  />