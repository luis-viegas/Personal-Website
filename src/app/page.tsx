...
import logoCoolLink from '@/images/logos/coollink.jpeg'
import logoBMW from '@/images/logos/bmw.jpeg'
import logoFEUP from '@/images/logos/feup.png'
...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <a href="/ResumeLuisViegas.pdf" download className="cursor-pointer">
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Software Engineer & AI Specialist building intelligent web systems.
          </h1>
          ...
          <div className="mt-6 flex gap-6">
            ...
            />
            <SocialLink
              href="https://www.linkedin.com/in/luis-viegas1/"
